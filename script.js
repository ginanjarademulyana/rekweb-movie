function searchMovies(keyword) {
    ...
    xhr.open('GET', 'http://www.omdbapi.com/?apikey=ce15cc0f&s=' + keyword );
    xhr.send();
}
    ...
    movies.forEach(function (movie) {
        cards += `<div class="col-4 my-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <a href="detail.php?id=${movie.indbID}" class="btn btn-primary">Show Detail</a>
                        </div>
                    </div>
                </div>`;
    });
